...
export default function Enter() {
  ...
  return (
    <div className="mt-16 px-4">
      <h3 className="text-3xl font-bold text-center">당근이지</h3>
      <div className="mt-8">
            ...
            {method === "phone" ? (
              <div className="flex rounded-md shadow-sm">
                ...
                <input
                  id="input"
                  type="number"
                  className="appearance-none w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm rounded-l-none placeholder-gray-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500"
                  required
                />
              </div>
            ) : null}
